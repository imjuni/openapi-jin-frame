    ...
    expect(result).toEqual([
      {
        ...
        property: {
          ...
          docs: [],
          name: 'body',
          type: "paths['pa/th/key']['get']['requestBody']['content']['application/json']",
    ...
    expect(result).toEqual([
      {
        ...
        property: {
          ...
          docs: [],
          name: 'body',
          type: "paths['pa/th/key']['get']['requestBody']['content']['multipart/form-data']",
          hasDeclareKeyword: true,
          isReadonly: true,
          hasQuestionToken: false,
          scope: 'public',
    ...
    expect(result).toEqual([
      {
        ...
        property: {
          ...
          docs: [],
          name: 'body',
          type: "Omit<paths['pa/th/key']['get']['requestBody']['content']['multipart/form-data'], 'photoUrls'>",
          hasDeclareKeyword: true,
          isReadonly: true,
          hasQuestionToken: false,
          scope: 'public',
